...
dConnectNetwork() {
    ...
    if [ -z "$NetworkName" ]; then
        ...
        docker network ls
        echo
        read -r "NetworkName?Enter the network name to connect: "
    fi
    ...
    if [ -z "$ContainerName" ]; then
        ...
        echo
        read -r "ContainerName?Enter the container name or ID to connect: "
    fi
...
dDisconnectNetwork() {
    ...
    if [ -z "$NetworkName" ]; then
        ...
        docker network ls
        echo
        read -r "NetworkName?Enter the network name to disconnect: "
    fi
    ...
    if [ -z "$ContainerName" ]; then
        ...
        echo
        read -r "ContainerName?Enter the container name or ID to disconnect: "
    fi
    ...
    d_show_result "✅ Container '$ContainerName' disconnected from '$NetworkName'." "❌ Failed to disconnect container '$ContainerName' from '$NetworkName'."
}
